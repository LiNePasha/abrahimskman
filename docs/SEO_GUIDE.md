# SEO Implementation Guide - إبراهيم شكمان
...
```env
NEXT_PUBLIC_SITE_URL=https://ibrahimskman.com
...
<BreadcrumbSchema items={[
  { name: 'الرئيسية', url: 'https://ibrahimskman.com' },
  { name: 'المنتجات', url: 'https://ibrahimskman.com/products' },
  { name: product.name, url: `https://ibrahimskman.com/products/${product.id}` }
]} />
```
...
3. أرسل sitemap: `https://ibrahimskman.com/sitemap.xml`
...
1. ✅ فحص الـ sitemap: `https://ibrahimskman.com/sitemap.xml`
2. ✅ فحص robots: `https://ibrahimskman.com/robots.txt`
