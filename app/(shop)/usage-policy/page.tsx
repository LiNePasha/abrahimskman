...
export const metadata: Metadata = {
  title: 'سياسة الاستخدام - إبراهيم شكمان',
  description: 'شروط وسياسة استخدام موقع إبراهيم شكمان. قواعد وإرشادات استخدام المتجر الإلكتروني',
      ...
      <div className="px-4 mx-auto max-w-4xl sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-600">
            شروط وقواعد استخدام متجر إبراهيم شكمان الإلكتروني
          </p>
        </div>
            ...
            <section className="mb-8">
              ...
              <div className="bg-brand-50 border-r-4 border-brand-500 p-6 rounded-xl">
                <p className="text-gray-700 leading-relaxed">
                  باستخدامك لموقع <strong>إبراهيم شكمان</strong>، فإنك توافق على الالتزام بهذه الشروط والأحكام.
            ...
            <section className="mb-8">
              ...
              <div className="p-6 bg-purple-50 border-2 border-purple-200 rounded-xl">
                <p className="text-gray-700 mb-4">
                  جميع المحتويات على الموقع (نصوص، صور، شعارات، رموز) هي ملكية <strong>إبراهيم شكمان</strong>
