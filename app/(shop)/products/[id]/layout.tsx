...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    ...
    const description = product.short_description 
      ...
      : `اشتري ${product.name} من إبراهيم شكمان - اكسسوارات وقطع غيار مميزة في مصر`
    
    return {
      title: `${product.name} | إبراهيم شكمان`,
      description,
      keywords: [
        product.name,
        'قطع غيار موتوسيكلات',
      ...
      alternates: {
        canonical: `https://ibrahimskman.com/products/${id}`,
      },
    }
  } catch (error) {
    return {
      title: 'منتج | إبراهيم شكمان',
