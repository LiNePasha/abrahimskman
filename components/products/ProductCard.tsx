...
export default function ProductCard({ 
  ...
  return (
    <div className={`${className}`}>
      <div className="group bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col h-full border border-gray-100 hover:border-brand-200">
        {/* Product Image */}
              ...
              <div className="flex gap-3">
                {showQuickView && (
                  <button
                    ...
                    className="bg-white hover:bg-gray-50 text-gray-800 p-3 rounded-full shadow-lg transform translate-y-4 group-hover:translate-y-0 transition-all duration-200 delay-75"
                    title="عرض سريع"
                  >
            ...
            {isVariable ? (
              <>
                ...
                <Link href={`/products/${product.id}`}>
                  <h3 className="text-sm md:text-base font-semibold text-gray-900 mb-2 line-clamp-2 group-hover:text-brand-600 transition-colors cursor-pointer">
                    {product.name}
                  </h3>
                </Link>
                ...
                <Link
                  ...
                  className="w-full py-2 text-sm font-bold text-center text-white transition-colors bg-purple-600 hover:bg-purple-700 rounded-lg"
                >
                  اختر الآن
                </Link>
              </>
              ...
              <>
                ...
                {/* Product Name - Smaller */}
                <Link href={`/products/${product.id}`}>
                  <h3 className="text-sm md:text-base font-semibold text-gray-900 mb-2 line-clamp-2 group-hover:text-brand-600 transition-colors cursor-pointer leading-snug">
                    {product.name}
                  </h3>
                </Link>
            ...
            <div className="px-2 pb-2 md:px-3 md:pb-3">
              ...
              {quantity > 0 && (
                <div className="mb-2 text-center">
                  <span className="bg-brand-100 text-brand-800 text-xs font-medium px-2 py-1 rounded-full">
                    في السلة: {quantity}
                  </span>
                </div>
              )}
